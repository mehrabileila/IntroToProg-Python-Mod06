...
# Leila Mehrabi,24/05/2030,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        for row in list_of_rows:
            taskToRemove, priority = dict(row).values()
...
class IO:
    ...
    def input_task_to_remove():
        ...
        """
        strKeyToRemove = input("Which TASK would you like removed? - ").strip()
